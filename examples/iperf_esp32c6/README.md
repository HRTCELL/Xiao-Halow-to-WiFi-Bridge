...
# Iperf Example (Xiao ESP32-C6)

This copy is configured for **Xiao ESP32-C6** and uses **ESP-IDF native WiFi** (no Morse Micro HaLow).  
Default target is `esp32c6`. Build with: `idf.py set-target esp32c6` then `idf.py build flash monitor`.

---

# Iperf Example (original)
