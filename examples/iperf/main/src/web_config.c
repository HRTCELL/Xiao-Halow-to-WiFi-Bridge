...
static const struct lang_strings lang_str[] = {
    ...
    [LANG_ES] = {
        ...
        .label_halow_pass = "Contrase\xc3" "n\xc3\xb1" "a HaLow",
        .label_ap_ssid   = "SSID AP 2.4 GHz",
        .label_ap_pass   = "Contrase\xc3" "n\xc3\xb1" "a AP 2.4 GHz",
        .label_country   = "C\xc3\xb3" "digo de pa\xc3\xads (ej. US)",
        .label_buffer    = "Tama\xc3\xb1" "o de b\xc3\xba" "fer TCP",
        .buffer_opt1     = "Peque\xc3\xb1" "o (16 KB)",
        .buffer_opt2     = "Mediano (32 KB)",
        .buffer_opt3     = "Grande (50 KB)",
        .hint_reboot     = "El tama\xc3\xb1" "o del b\xc3\xba" "fer tiene efecto tras reiniciar.",
        .btn_save        = "Guardar",
    ...
    [LANG_ZH] = {
        ...
        .refresh_hint  = "\xef\xbc\x88\xe6\xaf\x8f""15\xe7\xa7\x92\xe5\x88\xb7\xe6\x96\xb0\xef\xbc\x89",
        .label_halow_ssid = "HaLow AP (STA) SSID",
